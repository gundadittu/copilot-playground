# Helpful resources about the ReAct LLM framework
...
- https://python.langchain.com/docs/use_cases/more/agents/agents/sales_agent_with_context

# Helpful LLM resources
